...
class unet_3_mask_in(nn.Module):
    ...
    def __init__(self, input_channel, output_channel, track_running_static=True):
        super(unet_3_mask_in, self).__init__()
    ...
    def forward(self, input, mask):
        ...
        defeature3t = self.deconv4(features4)#256, 1/8
        defeature3 = torch.cat((self.unpool3(defeature3t), features3), 1)#512
        defeature2t = self.deconv3(defeature3)#128, 1/4
        defeature2 = torch.cat((self.unpool2(defeature2t), features2), 1)#256
        defeature1t = self.deconv2(defeature2)#64, 1/2
        defeature1 = torch.cat((self.unpool1(defeature1t), features1), 1)#128
